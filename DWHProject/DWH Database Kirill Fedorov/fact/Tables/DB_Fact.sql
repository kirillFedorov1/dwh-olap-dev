CREATE TABLE [fact].[DB_Fact] (
    ...
    CONSTRAINT [PK_fact_DB_Fact] PRIMARY KEY CLUSTERED ([nPartYearMonth] ASC, [FactID] ASC) WITH (STATISTICS_NORECOMPUTE = ON, STATISTICS_INCREMENTAL = ON) ON [ps_Range_Fact_nPartYearMonth] ([nPartYearMonth])
