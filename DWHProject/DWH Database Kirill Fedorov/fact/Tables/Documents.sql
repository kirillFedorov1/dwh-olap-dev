CREATE TABLE [fact].[Documents] (
    ...
    CONSTRAINT [PK_fact_Documents] PRIMARY KEY CLUSTERED ([nPartYearMonth] ASC, [DocID] ASC) WITH (STATISTICS_NORECOMPUTE = ON, STATISTICS_INCREMENTAL = ON) ON [ps_Range_Fact_nPartYearMonth] ([nPartYearMonth])
