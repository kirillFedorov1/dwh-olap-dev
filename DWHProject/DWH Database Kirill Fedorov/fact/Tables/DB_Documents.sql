CREATE TABLE [fact].[DB_Documents] (
    ...
    CONSTRAINT [PK_fact_DB_Documents] PRIMARY KEY CLUSTERED ([nPartYearMonth] ASC, [DocID] ASC) WITH (STATISTICS_NORECOMPUTE = ON, STATISTICS_INCREMENTAL = ON) ON [ps_Range_Fact_nPartYearMonth] ([nPartYearMonth])
